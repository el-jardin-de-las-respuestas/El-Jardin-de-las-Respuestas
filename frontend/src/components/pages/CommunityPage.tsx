                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <CardDescription>
                                        Explora las conversaciones activas
                                    </CardDescription>
                                </div>
                                <Button
                                    size="sm"
                        ...
                        <CardContent className="space-y-3">
                            ...
                            {forums.map((forum) => {
                                const count = communityPosts.filter(
                                    (p) => p.forum.id === forum.id
                                ).length;
                    ...
                    <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
                        ...
                        <CardContent>
                            <ul className="space-y-2 text-xs text-muted-foreground">
                                <li>
                                    • Respeto y empatía en todas las
                                    interacciones
                                </li>
                                <li>
                                    • No compartir información médica personal
                                    sensible
                                </li>
                                <li>
                                    • Las opiniones compartidas no sustituyen el
                                    consejo médico
                                </li>
