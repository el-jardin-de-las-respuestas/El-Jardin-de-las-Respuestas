...
export function FAQPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      {/* Search */}
      <Card className="mb-8 bg-white dark:bg-gray-900 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm">
        <CardContent className="pt-6">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-gray-50 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-500"
            />
          </div>
        </CardContent>
      </Card>
